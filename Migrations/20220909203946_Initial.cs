...
namespace WorkoutTracker.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ExerciseSetsAndReps",
                columns: table => new
                {
                    ExercisesId = table.Column<int>(type: "int", nullable: false),
                    SetsAndRepsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseSetsAndReps", x => new { x.ExercisesId, x.SetsAndRepsId });
                    table.ForeignKey(
                        name: "FK_ExerciseSetsAndReps_Exercise_ExercisesId",
                        column: x => x.ExercisesId,
                        principalTable: "Exercise",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExerciseSetsAndReps_SetsAndReps_SetsAndRepsId",
                        column: x => x.SetsAndRepsId,
                        principalTable: "SetsAndReps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryWorkout", x => new { x.CategoriesId, x.WorkoutsId });
                    table.ForeignKey(
                        name: "FK_CategoryWorkout_Category_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Category",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryWorkout_Workout_WorkoutsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryWorkout_WorkoutsId",
                table: "CategoryWorkout",
                column: "WorkoutsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseSetsAndReps_SetsAndRepsId",
                table: "ExerciseSetsAndReps",
                column: "SetsAndRepsId");
